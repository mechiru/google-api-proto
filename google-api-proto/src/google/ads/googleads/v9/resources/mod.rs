...
pub struct Recommendation {
    ...
    #[prost(oneof="recommendation::Recommendation", tags="4, 22, 8, 9, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20, 21, 23, 28, 29")]
...
pub struct AdGroupCriterion {
    ...
    ///
    /// Exactly one must be set.
    #[prost(oneof="ad_group_criterion::Criterion", tags="27, 28, 29, 30, 32, 36, 37, 38, 39, 42, 40, 41, 43, 45, 46, 47, 48, 49, 74, 75")]
