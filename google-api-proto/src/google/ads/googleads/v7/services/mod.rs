...
pub mod customer_user_access_invitation_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_customer_user_access_invitation(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.ads.googleads.v7.services.CustomerUserAccessInvitationService/GetCustomerUserAccessInvitation",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn mutate_customer_user_access_invitation(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.ads.googleads.v7.services.CustomerUserAccessInvitationService/MutateCustomerUserAccessInvitation",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
...
pub mod ad_group_bid_modifier_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn mutate_ad_group_bid_modifiers(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.ads.googleads.v7.services.AdGroupBidModifierService/MutateAdGroupBidModifiers",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
...
pub struct ConversionAdjustmentResult {
    ...
    pub conversion_identifier: ::core::option::Option<conversion_adjustment_result::ConversionIdentifier>,
}
...
pub mod bidding_strategy_simulation_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_bidding_strategy_simulation(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.ads.googleads.v7.services.BiddingStrategySimulationService/GetBiddingStrategySimulation",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
...
pub mod remarketing_action_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn mutate_remarketing_actions(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.ads.googleads.v7.services.RemarketingActionService/MutateRemarketingActions",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
...
pub mod customer_negative_criterion_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_customer_negative_criterion(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.ads.googleads.v7.services.CustomerNegativeCriterionService/GetCustomerNegativeCriterion",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        pub async fn mutate_customer_negative_criteria(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.ads.googleads.v7.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
...
pub mod ad_group_extension_setting_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn mutate_ad_group_extension_settings(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.ads.googleads.v7.services.AdGroupExtensionSettingService/MutateAdGroupExtensionSettings",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
...
pub mod campaign_bid_modifier_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn mutate_campaign_bid_modifiers(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.ads.googleads.v7.services.CampaignBidModifierService/MutateCampaignBidModifiers",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
...
pub struct MutateOperation {
    /// The mutate operation.
    #[prost(oneof="mutate_operation::Operation", tags="17, 1, 56, 2, 18, 3, 19, 20, 21, 5, 49, 22, 23, 6, 52, 7, 8, 13, 24, 25, 26, 27, 28, 10, 11, 12, 55, 57, 30, 31, 32, 34, 35, 36, 37, 53, 54, 38, 39, 40, 44, 50, 51, 45, 48, 41, 42, 43, 14, 15, 16")]
...
pub struct MutateOperationResponse {
    /// The mutate response.
    #[prost(oneof="mutate_operation_response::Response", tags="17, 1, 56, 2, 18, 3, 19, 20, 21, 5, 22, 49, 23, 6, 52, 7, 8, 13, 24, 25, 26, 27, 28, 10, 11, 12, 55, 57, 30, 31, 32, 34, 35, 36, 37, 53, 54, 38, 39, 40, 44, 45, 50, 51, 48, 41, 42, 43, 14, 15, 16")]
...
pub mod operating_system_version_constant_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_operating_system_version_constant(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.ads.googleads.v7.services.OperatingSystemVersionConstantService/GetOperatingSystemVersionConstant",
            );
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
