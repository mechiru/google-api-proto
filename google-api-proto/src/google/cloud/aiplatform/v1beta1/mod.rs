...
pub mod pipeline_job {
    ...
    pub struct RuntimeConfig {
        ...
        #[prost(btree_map = "string, message", tag = "1")]
        pub parameters:
            ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, super::Value>,
...
pub mod model_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Deletes a Model."]
        #[doc = ""]
        #[doc = " A model cannot be deleted if any [Endpoint][google.cloud.aiplatform.v1beta1.Endpoint] resource has a"]
        #[doc = " [DeployedModel][google.cloud.aiplatform.v1beta1.DeployedModel] based on the model in its"]
        #[doc = " [deployed_models][google.cloud.aiplatform.v1beta1.Endpoint.deployed_models] field."]
...
pub mod prediction_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = ""]
        #[doc = " * `X-Vertex-AI-Endpoint-Id`: ID of the [Endpoint][google.cloud.aiplatform.v1beta1.Endpoint] that served this"]
        #[doc = " prediction."]
        #[doc = ""]
        #[doc = " * `X-Vertex-AI-Deployed-Model-Id`: ID of the Endpoint's [DeployedModel][google.cloud.aiplatform.v1beta1.DeployedModel]"]
...
pub mod index_endpoint_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Update an existing DeployedIndex under an IndexEndpoint."]
...
pub mod pipeline_service_client {
    ...
    #[doc = " `PipelineJob` resources (used for Vertex AI Pipelines)."]
    #[derive(Debug, Clone)]
...
pub mod tensorboard_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> Result<tonic::Response<super::BatchCreateTensorboardTimeSeriesResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.aiplatform.v1beta1.TensorboardService/BatchCreateTensorboardTimeSeries") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        ) -> Result<tonic::Response<super::BatchReadTensorboardTimeSeriesDataResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.aiplatform.v1beta1.TensorboardService/BatchReadTensorboardTimeSeriesData") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        ) -> Result<tonic::Response<super::WriteTensorboardExperimentDataResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.aiplatform.v1beta1.TensorboardService/WriteTensorboardExperimentData") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
...
pub mod vizier_service_client {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    #[doc = " Vertex AI Vizier API."]
    #[doc = ""]
    #[doc = " Vertex AI Vizier is a service to solve blackbox optimization problems,"]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " suggested by Vertex AI Vizier. Returns a long-running"]
