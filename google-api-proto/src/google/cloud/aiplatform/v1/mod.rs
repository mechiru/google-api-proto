...
pub mod model_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Deletes a Model."]
        #[doc = ""]
        #[doc = " A model cannot be deleted if any [Endpoint][google.cloud.aiplatform.v1.Endpoint] resource has a"]
        #[doc = " [DeployedModel][google.cloud.aiplatform.v1.DeployedModel] based on the model in its"]
        #[doc = " [deployed_models][google.cloud.aiplatform.v1.Endpoint.deployed_models] field."]
