...
pub struct ComponentSettings {
    ...
    pub detector_settings: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, component_settings::DetectorSettings>,
...
pub struct Settings {
    ...
    pub component_settings: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ComponentSettings>,
    ...
    pub detector_group_settings: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, settings::DetectorGroupSettings>,
