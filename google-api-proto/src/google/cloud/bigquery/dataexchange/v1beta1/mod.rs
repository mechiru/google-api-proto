...
pub struct Listing {
    ...
    #[prost(
        enumeration = "super::common::Category",
        repeated,
        packed = "false",
        tag = "10"
    )]
...
pub mod analytics_hub_service_client {
    ...
    use tonic::codegen::*;
    #[doc = " The AnalyticsHubService API facilitates data sharing within and across"]
    #[doc = " organizations. It allows data providers to publish Listings --- a"]
    #[doc = " discoverable and searchable SKU representing a dataset. Data consumers can"]
    #[doc = " subscribe to Listings. Upon subscription, AnalyticsHub provisions a \"Linked"]
    #[doc = " Datasets\" surfacing the data in the consumer's project."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Lists DataExchanges in a given project and location."]
        ...
        #[doc = " Lists DataExchanges from projects in a given organization and location."]
        pub async fn list_org_data_exchanges(
            &mut self,
            request: impl tonic::IntoRequest<super::ListOrgDataExchangesRequest>,
        ) -> Result<tonic::Response<super::ListOrgDataExchangesResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                    format!("Service was not ready: {}", e.into()),
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.bigquery.dataexchange.v1beta1.AnalyticsHubService/ListOrgDataExchanges") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Gets details of a single DataExchange."]
        ...
        #[doc = " Creates a new DataExchange in a given project and location."]
        pub async fn create_data_exchange(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.bigquery.dataexchange.v1beta1.AnalyticsHubService/CreateDataExchange") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Updates the parameters of a single DataExchange."]
        pub async fn update_data_exchange(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.bigquery.dataexchange.v1beta1.AnalyticsHubService/UpdateDataExchange") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Deletes a single DataExchange."]
        pub async fn delete_data_exchange(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.bigquery.dataexchange.v1beta1.AnalyticsHubService/DeleteDataExchange") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Lists Listings in a given project and location."]
        ...
        #[doc = " Gets details of a single Listing."]
        ...
        #[doc = " Creates a new Listing in a given project and location."]
        ...
        #[doc = " Updates the parameters of a single Listing."]
        ...
        #[doc = " Deletes a single Listing, as long as there are no subscriptions"]
        #[doc = " associated with the source of this Listing."]
        ...
        #[doc = " Subscribes to a single Listing."]
        #[doc = ""]
        #[doc = " Data Exchange currently supports one type of Listing: a BigQuery dataset."]
        #[doc = " Upon subscription to a Listing for a BigQuery dataset, Data Exchange"]
        #[doc = " creates a linked dataset in the subscriber's project."]
        ...
        #[doc = " Gets the IAM policy for a dataExchange or a listing."]
        ...
        #[doc = " Sets the IAM policy for a dataExchange or a listing."]
        ...
        #[doc = " Returns the permissions that a caller has on a specified dataExchange or"]
        #[doc = " listing."]
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http :: uri :: PathAndQuery :: from_static ("/google.cloud.bigquery.dataexchange.v1beta1.AnalyticsHubService/TestIamPermissions") ;
            self.inner.unary(request.into_request(), path, codec).await
        }
    }
}
