...
pub struct StructStats {
    ...
    #[prost(btree_map = "string, message", tag = "1")]
    pub field_stats:
        ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, DataStats>,
}
...
pub struct TablesDatasetMetadata {
    ...
    pub target_column_correlations:
        ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, CorrelationStats>,
...
pub struct TablesModelMetadata {
    ...
    pub additional_optimization_objective_config:
        ::core::option::Option<tables_model_metadata::AdditionalOptimizationObjectiveConfig>,
}
...
pub mod auto_ml_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " For Tables:"]
        #[doc = " *   A"]
        #[doc = " [schema_inference_version][google.cloud.automl.v1beta1.InputConfig.params]"]
        ...
        #[doc = " Lists table specs in a dataset."]
        ...
        #[doc = " Lists column specs in a table spec."]
        ...
        #[doc = " (as e.g. changing"]
        #[doc = ""]
        #[doc = " [node_number][google.cloud.automl.v1beta1.ImageObjectDetectionModelDeploymentMetadata.node_number])"]
        ...
        #[doc = ""]
        #[doc = " [ModelExportOutputConfig][google.cloud.automl.v1beta1.ModelExportOutputConfig]."]
        #[doc = ""]
        #[doc = " Returns an empty response in the"]
        #[doc = " [response][google.longrunning.Operation.response] field when it completes."]
        ...
        #[doc = " Exports examples on which the model was evaluated (i.e. which were in the"]
        #[doc = " TEST set of the dataset the model was created from), together with their"]
        #[doc = " ground truth annotations and the annotations created (predicted) by the"]
        #[doc = " model."]
        #[doc = " The examples, ground truth and predictions are exported in the state"]
        #[doc = " they were at the moment the model was evaluated."]
        #[doc = ""]
        #[doc = " This export is available only for 30 days since the model evaluation is"]
        #[doc = " created."]
        #[doc = ""]
        #[doc = " Currently only available for Tables."]
        #[doc = ""]
        #[doc = " Returns an empty response in the"]
        #[doc = " [response][google.longrunning.Operation.response] field when it completes."]
...
pub mod prediction_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Perform an online prediction. The prediction result will be directly"]
        #[doc = " returned in the response."]
        #[doc = " Available for following ML problems, and their expected request payloads:"]
        #[doc = " * Image Classification - Image in .JPEG, .GIF or .PNG format, image_bytes"]
        #[doc = "                          up to 30MB."]
        #[doc = " * Image Object Detection - Image in .JPEG, .GIF or .PNG format, image_bytes"]
        #[doc = "                            up to 30MB."]
        #[doc = " * Text Classification - TextSnippet, content up to 60,000 characters,"]
        #[doc = "                         UTF-8 encoded."]
        #[doc = " * Text Extraction - TextSnippet, content up to 30,000 characters,"]
        #[doc = "                     UTF-8 NFC encoded."]
        #[doc = " * Translation - TextSnippet, content up to 25,000 characters, UTF-8"]
        #[doc = "                 encoded."]
        #[doc = " * Tables - Row, with column values matching the columns of the model,"]
        #[doc = "            up to 5MB. Not available for FORECASTING"]
        #[doc = ""]
        #[doc = " [prediction_type][google.cloud.automl.v1beta1.TablesModelMetadata.prediction_type]."]
        #[doc = " * Text Sentiment - TextSnippet, content up 500 characters, UTF-8"]
        #[doc = "                     encoded."]
        ...
        #[doc = " Perform a batch prediction. Unlike the online [Predict][google.cloud.automl.v1beta1.PredictionService.Predict], batch"]
        ...
        #[doc = " method. Once the operation is done, [BatchPredictResult][google.cloud.automl.v1beta1.BatchPredictResult] is returned in"]
        #[doc = " the [response][google.longrunning.Operation.response] field."]
        #[doc = " Available for following ML problems:"]
        #[doc = " * Image Classification"]
        #[doc = " * Image Object Detection"]
        #[doc = " * Video Classification"]
        #[doc = " * Video Object Tracking * Text Extraction"]
        #[doc = " * Tables"]
