...
pub struct FeatureMap {
    ...
    pub categorical_features: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, feature_map::StringList>,
    ...
    pub numerical_features: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, feature_map::FloatList>,
}
...
pub struct ProductCatalogItem {
    ...
    pub costs: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, f32>,
...
pub struct PurchaseTransaction {
    ...
    #[prost(btree_map="string, float", tag="3")]
    pub taxes: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, f32>,
