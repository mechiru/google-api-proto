...
pub mod tpu_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn list_nodes(
            ...
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.tpu.v2alpha1.Tpu/ListNodes");
        ...
        pub async fn get_node(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.tpu.v2alpha1.Tpu/GetNode");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Creates a node."]
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.tpu.v2alpha1.Tpu/CreateNode");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Deletes a node."]
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.tpu.v2alpha1.Tpu/DeleteNode");
            self.inner.unary(request.into_request(), path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.tpu.v2alpha1.Tpu/StopNode");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Starts a node."]
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/google.cloud.tpu.v2alpha1.Tpu/StartNode");
            self.inner.unary(request.into_request(), path, codec).await
        }
        #[doc = " Updates the configurations of a node."]
        ...
        ) -> Result<tonic::Response<super::GenerateServiceIdentityResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " Lists runtime versions supported by this API."]
        ...
        #[doc = " Retrieves the guest attributes for the node."]
