...
pub mod analysis_result {
    ...
    pub struct CallAnalysisMetadata {
        ...
        pub entities:
            ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, super::Entity>,
        ...
        pub intents:
            ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, super::Intent>,
