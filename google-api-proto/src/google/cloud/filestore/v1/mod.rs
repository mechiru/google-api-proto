...
pub mod cloud_filestore_manager_client {
    ...
    #[doc = ""]
    #[doc = " Cloud Filestore Manager v1."]
    #[doc = ""]
    #[doc = " The `file.googleapis.com` service implements the Cloud Filestore API and"]
    #[doc = " defines the following resource model for managing instances:"]
    ...
    #[doc = "   `/projects/{project_number}/locations/{location_id}/instances/{instance_id}`"]
    #[doc = "   and backups are resources of the form:"]
    #[doc = "   `/projects/{project_number}/locations/{location_id}/backup/{backup_id}`"]
    #[doc = ""]
    #[doc = " Note that location_id must be a GCP `zone` for instances and but to a GCP"]
    #[doc = " `region` for backups; for example:"]
    #[doc = " * `projects/12345/locations/us-central1-c/instances/my-filestore`"]
    #[doc = " * `projects/12345/locations/us-central1/backups/my-backup`"]
    #[derive(Debug, Clone)]
