...
pub mod gke_hub_membership_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " ValidateExclusivity validates the state of exclusivity in the cluster."]
        #[doc = " The validation does not depend on an existing Hub membership resource."]
        ...
        #[doc = " GenerateExclusivityManifest generates the manifests to update the"]
        #[doc = " exclusivity artifacts in the cluster if needed."]
        #[doc = ""]
        #[doc = " Exclusivity artifacts include the Membership custom resource definition"]
        #[doc = " (CRD) and the singleton Membership custom resource (CR). Combined with"]
        #[doc = " ValidateExclusivity, exclusivity artifacts guarantee that a Kubernetes"]
        #[doc = " cluster is only registered to a single GKE Hub."]
        #[doc = ""]
        #[doc = " The Membership CRD is versioned, and may require conversion when the GKE"]
        #[doc = " Hub API server begins serving a newer version of the CRD and"]
        #[doc = " corresponding CR. The response will be the converted CRD and CR if there"]
        #[doc = " are any differences between the versions."]
        pub async fn generate_exclusivity_manifest(
            &mut self,
            request: impl tonic::IntoRequest<super::GenerateExclusivityManifestRequest>,
        ) -> Result<tonic::Response<super::GenerateExclusivityManifestResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
