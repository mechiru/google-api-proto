...
pub struct BatchTranslateTextRequest {
    ...
    pub models: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
    /// Required. Input configurations.
    ...
    pub glossaries: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, TranslateTextGlossaryConfig>,
    /// Optional. The labels with user-defined metadata for the request.
    ///
    /// Label keys and values can be no longer than 63 characters
    /// (Unicode codepoints), can only contain lowercase letters, numeric
...
pub struct BatchTranslateDocumentRequest {
    ...
    /// original file.
    #[prost(btree_map="string, string", tag="8")]
    pub format_conversions: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
}
