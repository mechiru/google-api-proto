...
pub struct Shipment {
    ...
    pub load_demands:
        ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, shipment::Load>,
...
pub mod shipment {
    ...
    pub struct VisitRequest {
        ...
        pub load_demands:
            ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, Load>,
...
pub struct Vehicle {
    ...
    pub load_limits:
        ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, vehicle::LoadLimit>,
...
pub mod shipment_route {
    ...
    pub struct Transition {
        ...
        #[prost(btree_map = "string, message", tag = "11")]
        pub vehicle_loads:
            ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, VehicleLoad>,
