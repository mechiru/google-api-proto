...
pub struct ResourceSearchResult {
    ...
    pub relationships: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, RelatedResources>,
...
pub mod iam_policy_search_result {
    ...
    pub struct Explanation {
        ...
        pub matched_permissions: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, explanation::Permissions>,
    }
