...
pub struct EventExecutionSnapshot {
    ...
    /// Snapshot metadata.
    #[prost(message, optional, tag="3")]
    pub event_execution_snapshot_metadata: ::core::option::Option<event_execution_snapshot::EventExecutionSnapshotMetadata>,
    ...
    #[prost(btree_map="string, message", tag="6")]
    pub event_params: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, EventParameter>,
    /// The parameters in Event object that differs from last snapshot.
    #[prost(btree_map="string, message", tag="7")]
    pub diff_params: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, EventParameter>,
}
