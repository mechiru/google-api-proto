...
pub mod actions_sdk_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn write_preview(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::WritePreviewRequest>,
        ...
        pub async fn create_version(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::CreateVersionRequest>,
        ...
        ) -> Result<tonic::Response<tonic::codec::Streaming<super::ReadDraftResponse>>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        #[doc = " before the first push or after changing the client secret) or to re-encrypt"]
        #[doc = " a client secret using the latest primary key version (considering key"]
        #[doc = " rotation)."]
        ...
        #[doc = " Decrypts the OAuth client secret used in account linking flows."]
        #[doc = " This can be used to view the client secret (e.g. after pulling a project)."]
        ...
        #[doc = " Lists all versions and their current states."]
...
pub mod actions_testing_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Finds the intents that match a given query."]
        ...
        #[doc = " Sets the Web & App Activity control on a service account."]
        #[doc = ""]
        #[doc = " It is necessary to have this setting enabled in order to use call Actions."]
        #[doc = " The setting is originally disabled for service accounts, and it is"]
        #[doc = " preserved until set to a different value. This means it only needs to be"]
        #[doc = " enabled once per account (and not necessarily once per test), unless it is"]
        #[doc = " later disabled."]
        #[doc = ""]
        #[doc = " Returns an error if the caller is not a service account. User accounts can"]
        #[doc = " change this setting via the Activity Controls page. See"]
        #[doc = " https://support.google.com/websearch/answer/54068."]
