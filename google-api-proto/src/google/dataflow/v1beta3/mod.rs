...
pub struct Job {
    ...
    #[prost(btree_map="string, string", tag="13")]
    pub transform_name_mapping: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
...
pub struct JobExecutionInfo {
    ...
    pub stages: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, JobExecutionStageInfo>,
}
...
pub struct LaunchFlexTemplateParameter {
    ...
    pub launch_options: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
    ...
    pub transform_name_mappings: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
    /// Launch Mechanism.
...
pub struct FlexTemplateRuntimeEnvironment {
    ...
    pub additional_user_labels: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
...
pub struct ParameterMetadata {
    ...
    pub custom_metadata: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
}
...
pub struct InvalidTemplateParameters {
    ...
    #[prost(message, repeated, tag="1")]
    pub parameter_violations: ::prost::alloc::vec::Vec<invalid_template_parameters::ParameterViolation>,
}
