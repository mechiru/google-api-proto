...
pub struct Notification {
    ...
    pub custom_attributes: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
    /// HTTP 1.1 \[<https://tools.ietf.org/html/rfc7232#section-2.3\][Entity> tag]
...
pub mod storage_client {
    ...
    use tonic::codegen::*;
    /// This is the API specification for the v1 Google Cloud Storage service. It is
    /// only used for the message definitions needed by Cloud Audit Logging. The v1
    /// gRPC service no longer runs and instead Google Cloud Storage only supports v2
    /// API calls.
    #[derive(Debug, Clone)]
