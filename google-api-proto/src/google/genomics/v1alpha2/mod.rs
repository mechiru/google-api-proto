...
pub struct RunPipelineArgs {
    ...
    pub inputs: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
    /// Pipeline output arguments; keys are defined in the pipeline
    /// documentation.  All output parameters of without default values
    /// must be specified.  If parameters with defaults are specified
    /// here, the defaults will be overridden.
    #[prost(btree_map="string, string", tag="3")]
    pub outputs: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
...
pub struct ControllerConfig {
    ...
    pub disks: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
    #[prost(btree_map="string, message", tag="7")]
    pub gcs_sources: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, controller_config::RepeatedString>,
    #[prost(btree_map="string, message", tag="8")]
    pub gcs_sinks: ::prost::alloc::collections::BTreeMap<::prost::alloc::string::String, controller_config::RepeatedString>,
}
