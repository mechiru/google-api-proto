...
pub mod vehicle_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Instantiates a new vehicle associated with an on-demand rideshare or"]
        #[doc = " deliveries provider. Each `Vehicle` must have a unique vehicle ID."]
        #[doc = ""]
        ...
        #[doc = " * `current_route_segment_end_point`"]
        #[doc = " * `current_route_segment_version`"]
        #[doc = " * `current_route_segment_traffic`"]
        #[doc = " * `route`"]
        #[doc = " * `waypoints`"]
        #[doc = " * `waypoints_version`"]
        #[doc = " * `remaining_distance_meters`"]
        #[doc = " * `remaining_time_seconds`"]
        ...
        #[doc = " Returns a vehicle from the Fleet Engine."]
        ...
        #[doc = " Writes updated vehicle data to the Fleet Engine."]
        #[doc = ""]
        #[doc = " When updating a `Vehicle`, the following fields cannot be updated since"]
        #[doc = " they are managed by the server:"]
        #[doc = ""]
        #[doc = " * `currentTrips`"]
        #[doc = " * `availableCapacity`"]
        #[doc = " * `current_route_segment_version`"]
        ...
        #[doc = ""]
        #[doc = " If the `attributes` field is updated, **all** the vehicle's attributes are"]
        #[doc = " replaced with the attributes provided in the request. If you want to update"]
        #[doc = " only some attributes, see the `UpdateVehicleAttributes` method. Likewise,"]
        ...
        #[doc = " Returns a paginated list of vehicles associated with"]
        ...
        #[doc = " Returns a list of vehicles that match the request options."]
